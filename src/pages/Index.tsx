    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-2xl font-bold text-foreground">СпецТехАренда</h1>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="#catalog" className="text-foreground/60 hover:text-primary transition-colors">Каталог</a>
              <a href="#services" className="text-foreground/60 hover:text-primary transition-colors">Услуги</a>
              <a href="#about" className="text-foreground/60 hover:text-primary transition-colors">О компании</a>
              <a href="#pricing" className="text-foreground/60 hover:text-primary transition-colors">Прайс-лист</a>
              <a href="#contacts" className="text-foreground/60 hover:text-primary transition-colors">Контакты</a>
            </nav>
      ...
      <section className="bg-gradient-to-r from-primary to-primary/90 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/80">Широкий парк современной техники для строительства и земляных работ</p>
      ...
      <section id="catalog" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">Каталог техники</h3>
            <p className="text-lg text-foreground/60">Современная и исправная техника для любых задач</p>
          </div>
              ...
              <Card key={item.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-2xl font-bold text-primary">{item.price} ₽/сутки</span>
                    <Dialog>
      ...
      <section id="services" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">Услуги аренды</h3>
            <p className="text-lg text-foreground/60">Гибкие условия для любых проектов</p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-foreground/60">Единиц техники</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary">15</div>
                  <div className="text-foreground/60">Лет опыта</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-foreground/60">Техническая поддержка</div>
                </div>
              </div>
            </div>
            <div className="bg-foreground text-white p-8 rounded-lg">
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">Прайс-лист</h3>
            <p className="text-lg text-foreground/60">Прозрачные цены без скрытых доплат</p>
          </div>
      ...
      <section id="contacts" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-foreground/60">Свяжитесь с нами удобным способом</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center">
              ...
              <CardContent>
                ...
                <p className="text-foreground/60">Круглосуточно</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                ...
                <p className="text-foreground/60">Ответим в течение часа</p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                ...
                <p className="text-foreground/60">ул. Промышленная, 25</p>
              </CardContent>
            </Card>
          </div>
        </div>
